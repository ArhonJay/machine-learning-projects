...
int distance_sensor_threshold = 1; // since iba yung distance niyo Mitch, try na baguhin toh depende if 1 is may detection or 0 if may detection
//kapag baliktad naman yung orientation ng ikot niya kapag may detection sa left and right, pagpalitin niyo lang pins ng distance left and right
